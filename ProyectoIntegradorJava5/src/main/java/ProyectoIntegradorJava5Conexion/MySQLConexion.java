...
public class MySQLConexion {
	...
	static {
		try {
			...
			System.out.println("Se cargo el controlador correctamente ARCHIVO: MySQLConexion.java");
		} 
	     catch (ClassNotFoundException e) {
			System.err.println("Error al cargar el controlador ARCHIVO: MySQLConexion.java");
			e.printStackTrace();
		}
	...
	public Connection conectar() {
		...
		try {
			...
			System.out.println("Error al establecer la conexion ARCHIVO: MySQLConexion.java");
			e.printStackTrace();
		}
		return conexion;
	}
